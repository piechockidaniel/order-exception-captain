...
| Public repository with visible MIT/Apache license and README | complete | Anonymous GitHub lookup confirms the repository is public and visibly MIT-licensed with a README. Public `main` contains runtime release `3a24f88` and its deployment record, verified on 2026-09-03. |
